...
#SBATCH --job-name=avg_diffae_pit_l1MagPen0.01_10ts_constLR # Job name
#SBATCH --output=slurm_%x.%j.out                            # File containing STDOUT output
#SBATCH --error=slurm_%x.%j.err                             # File containing STDERR output. If ommited, use STDOUT.

# Commands / scripts to run (e.g., python3 train.py)

python train_latent.py --run_name "avg_diffae_pit_l1MagPen0.01_10ts_constLR" --max_timesteps 10 --batch_size 24576 --epochs 15 --magnitude_loss_weight 0.01
